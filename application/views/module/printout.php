...
<table border="1">
                        ...
                        <div style="float: right;">
                            <div align="center">
                            <p style="font-size: 15px;"><?php echo ucfirst(strtolower($this->db->get_where("data_desa",array("id"=>$id_desa))->row()->nama_desa)); ?>, 
                            ...
                            <br><br><br>
                            <p style="font-size: 14px;"><?php echo strtoupper($this->db->get_where("data_desa",array("id"=>$id_desa))->row()->nama_kepala_desa); ?></p>
                            </div>
                        </div>                   
